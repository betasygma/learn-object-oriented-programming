...
import java.util.*;
import java.io.FileInputStream; // Tambahan import agar aman
...
public class Recommender {
    ...
    // ************************************************************************************************* \\
    // INI ADALAH BAGIAN YANG SUDAH DIPERBAIKI STRUKTURNYA
    // Method ini sekarang ada DI DALAM class Recommender, bukan di luarnya.
    private static BufferedReader getBufferedReader(String fileName) {
        try {
            // Menggunakan FileInputStream untuk membaca langsung dari folder proyek
            return new BufferedReader(new InputStreamReader(new java.io.FileInputStream(fileName)));
...
} // Kurung kurawal penutup Class Recommender (INI HARUS ADA DI PALING AKHIR)